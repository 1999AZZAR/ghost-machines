...
RUN git clone --depth=1 https://github.com/1999AZZAR/hela-mcp-ecosystem.git /opt/mcp-ecosystem \
    ...
    && mkdir -p /root/.mcp /root/.config/opencode /root/.config/kilo \
    ...
    && node scripts/generate-config.mjs headless-server --backend kilo --root /opt/mcp-ecosystem --out /root/.config/kilo/config.json \
...
RUN if getent group ${HOST_GID} >/dev/null; then \
    ...
    mkdir -p /home/${GHOST_USER}/.ssh /home/${GHOST_USER}/.mcp /home/${GHOST_USER}/.config/opencode /home/${GHOST_USER}/.config/kilo /home/${GHOST_USER}/.agents/plugins /home/${GHOST_USER}/.agents/skills /home/${GHOST_USER}/.gemini/config/plugins /home/${GHOST_USER}/.local/bin /home/${GHOST_USER}/.cargo/bin && \
    ...
    cp /root/.config/kilo/config.json /home/${GHOST_USER}/.config/kilo/config.json 2>/dev/null || true && \
